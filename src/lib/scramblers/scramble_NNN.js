...
export default {
	'4x4x4': generate_NNN_scrambler(4, 40, true),
	'5x5x5': generate_NNN_scrambler(5, 60, true),
	'6x6x6': generate_NNN_scrambler(6, 80, true),
	'7x7x7': generate_NNN_scrambler(7, 100, true),
};
